...
@JsonSerializable(explicitToJson: true)
class DeleteElectricityMeterCommand {
  const DeleteElectricityMeterCommand({
    required this.electricityMeterId,
  });

  factory DeleteElectricityMeterCommand.fromJson(Map<String, dynamic> json) =>
      _$DeleteElectricityMeterCommandFromJson(json);

  static const toJsonFactory = _$DeleteElectricityMeterCommandToJson;
  Map<String, dynamic> toJson() => _$DeleteElectricityMeterCommandToJson(this);

  @JsonKey(name: 'electricityMeterId')
  final String electricityMeterId;
  static const fromJsonFactory = _$DeleteElectricityMeterCommandFromJson;

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is DeleteElectricityMeterCommand &&
...
extension $DeleteElectricityMeterCommandExtension
    on DeleteElectricityMeterCommand {
  DeleteElectricityMeterCommand copyWith({String? electricityMeterId}) {
    return DeleteElectricityMeterCommand(
        electricityMeterId: electricityMeterId ?? this.electricityMeterId);
  }

  DeleteElectricityMeterCommand copyWithWrapped(
      {Wrapped<String>? electricityMeterId}) {
    return DeleteElectricityMeterCommand(
...
class DeleteProducerCommand {
  const DeleteProducerCommand({
    required this.producerId,
  });

  factory DeleteProducerCommand.fromJson(Map<String, dynamic> json) =>
      _$DeleteProducerCommandFromJson(json);

  static const toJsonFactory = _$DeleteProducerCommandToJson;
  Map<String, dynamic> toJson() => _$DeleteProducerCommandToJson(this);

  @JsonKey(name: 'producerId')
  final String producerId;
  static const fromJsonFactory = _$DeleteProducerCommandFromJson;

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is DeleteProducerCommand &&
  ...
  @override
  int get hashCode =>
      const DeepCollectionEquality().hash(producerId) ^ runtimeType.hashCode;
}

extension $DeleteProducerCommandExtension on DeleteProducerCommand {
  DeleteProducerCommand copyWith({String? producerId}) {
    return DeleteProducerCommand(producerId: producerId ?? this.producerId);
  }

  DeleteProducerCommand copyWithWrapped({Wrapped<String>? producerId}) {
...
@JsonSerializable(explicitToJson: true)
class DeleteSwitchConsumerCommand {
  const DeleteSwitchConsumerCommand({
    required this.switchConsumerId,
  });

  factory DeleteSwitchConsumerCommand.fromJson(Map<String, dynamic> json) =>
      _$DeleteSwitchConsumerCommandFromJson(json);

  static const toJsonFactory = _$DeleteSwitchConsumerCommandToJson;
  Map<String, dynamic> toJson() => _$DeleteSwitchConsumerCommandToJson(this);

  @JsonKey(name: 'switchConsumerId')
  final String switchConsumerId;
  static const fromJsonFactory = _$DeleteSwitchConsumerCommandFromJson;

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is DeleteSwitchConsumerCommand &&
...
extension $DeleteSwitchConsumerCommandExtension on DeleteSwitchConsumerCommand {
  DeleteSwitchConsumerCommand copyWith({String? switchConsumerId}) {
    return DeleteSwitchConsumerCommand(
        switchConsumerId: switchConsumerId ?? this.switchConsumerId);
  }

  DeleteSwitchConsumerCommand copyWithWrapped(
